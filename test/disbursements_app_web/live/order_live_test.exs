defmodule DisbursementsAppWeb.OrderLiveTest do
  ...
  @create_attrs %{amount: 120.5, completed_at: "2010-04-17T14:00:00Z", created_at: "2010-04-17T14:00:00Z"}
  ...
  defp fixture(:order) do
    {:ok, order} = Disb.create_order(@create_attrs)
    order
  end
